...
import com.oars.dao.RoleClaimRepository;
import com.oars.dao.RoleHistoryRepository;
...
import com.oars.entity.RoleClaim;
import com.oars.entity.RoleHistory;
import com.oars.entity.Status;
import com.oars.entity.UserRole;
import com.oars.exception.ClaimNotFoundException;
import com.oars.exception.RoleNotFoundException;
import com.oars.exception.UserManagementException;
import com.oars.modelmapper.ClaimMapper;
import com.oars.modelmapper.RoleMapper;
import com.oars.service.RoleService;
...
public class RoleServiceImpl implements RoleService {
    ...
    public List<RoleDto> getAllRoles() {
        ...
        return roles.stream()
            .filter(role -> !(role.getName().equals(com.oars.constant.Role.DEFAULT.getName())
                || role.getName().equals(com.oars.constant.Role.SYSTEM_ADMIN.getName())))
            .map(role -> {
